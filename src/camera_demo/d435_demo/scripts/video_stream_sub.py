...
class NodeSubscribe:
    ...
    def __init__(self, camera_index=0):
        ...
        color_topic = f'/camera_{camera_index}/color/image_raw'
        depth_topic = f'/camera_{camera_index}/depth/image_raw'
...
def main():
    ...
    camera_topic = f'/camera_{camera_index}/color/image_raw'
