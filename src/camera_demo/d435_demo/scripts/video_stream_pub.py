...
class RealSenseCamera:
    ...
    def start_camera_pipeline(self, pipeline, camera_index):
        ...
        color_pub = rospy.Publisher(f'/camera_{camera_index}/color/image_raw', Image, queue_size=10)
        depth_pub = rospy.Publisher(f'/camera_{camera_index}/depth/image_raw', Image, queue_size=10)
